...
public class CapyModel extends GeoModel<CapybaraEntity> {
    @Override
    public Identifier getModelResource(CapybaraEntity animatable) {
        return new Identifier(Capy.MOD_ID,"geo/capybara.geo.json");
    }
    ...
    public Identifier getAnimationResource(CapybaraEntity animatable) {
        return new Identifier(Capy.MOD_ID,"animations/model.animation.json");
    }
    @Override
